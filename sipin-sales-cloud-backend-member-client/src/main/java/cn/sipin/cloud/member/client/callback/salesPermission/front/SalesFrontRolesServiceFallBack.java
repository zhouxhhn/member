 ...
 */
@Component
public class SalesFrontRolesServiceFallBack implements SalesFrontRolesService {

  @Override public ResponseData<Page<SalesRole>> index(int page, int size) {
  ...
  @Override public ResponseData addRoles(AddSalesFrontRolesRequest request) {
    return ResponseData.build(
        ResponseBackCode.ERROR_DOWNGRADE.getValue(),
        ResponseBackCode.ERROR_DOWNGRADE.getMessage()
    );
  ...
  @Override public ResponseData update(Long roleId, UpdateSalesFrontRolesRequest request) {
    return ResponseData.build(
        ResponseBackCode.ERROR_DOWNGRADE.getValue(),
        ResponseBackCode.ERROR_DOWNGRADE.getMessage()
    );
