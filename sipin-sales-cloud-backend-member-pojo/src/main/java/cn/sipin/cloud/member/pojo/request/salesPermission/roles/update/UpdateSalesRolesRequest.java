 ...
 */
package cn.sipin.cloud.member.pojo.request.salesPermission.roles.update;
 ...
 */
@Data
public class UpdateSalesRolesRequest {
  ...
  @ApiModelProperty(value = "类型：公有为0，私有为1",required = true)
