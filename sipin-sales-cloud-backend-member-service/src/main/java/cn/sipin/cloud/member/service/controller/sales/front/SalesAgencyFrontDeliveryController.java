...
public class SalesAgencyFrontDeliveryController {
  ...
  @Autowired
  public SalesAgencyFrontDeliveryController(SalesAgencyDeliveryServiceContract salesAgencyDeliveryService){
  ...
  public ResponseData addAddress(@RequestBody SaveSalesAgencyFrontDeliveryRequest request) {
    return salesAgencyDeliveryService.frontAddAddress(request);
  }
  ...
  public ResponseData updateAddress(@PathVariable Long addressId, @RequestBody UpdateSalesAgencyDeliveryRequest request) {
  ...
  public ResponseData<Page> index(
     ...
     return salesAgencyDeliveryService.searchAllAddress(page,size);
  }
